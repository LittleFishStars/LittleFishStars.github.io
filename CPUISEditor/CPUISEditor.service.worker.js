...
/** @type {string} */
const CACHE_VERSION = '1753973838|875204324';
/** @type {string} */
const CACHE_PREFIX = 'CPU Instruction -sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'CPUISEditor.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["CPUISEditor.html","CPUISEditor.js","CPUISEditor.offline.html","CPUISEditor.icon.png","CPUISEditor.apple-touch-icon.png","CPUISEditor.audio.worklet.js","CPUISEditor.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["CPUISEditor.wasm","CPUISEditor.pck"];
